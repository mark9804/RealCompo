...
class AttentionStore(AttentionControl):
    ...
    def between_steps(self):
        ...
        self.step_store_save = self.step_store.copy()
    ...
    def __init__(self):
        ...
        self.step_store = self.get_empty_store()
        self.attention_store = {}
        self.step_store_save = self.get_empty_store()
...
def aggregate_attention(
    ...
    for location in from_where:
        ...
        if key in attention_maps and attention_maps[key]:
    ...
    if not out:
        return torch.zeros((res, res, 77), device="cpu")
...
def aggregate_attention_each_step(
        attention_store: AttentionStore,
        res: int,
        from_where: List[str],
        is_cross: bool,
...
def show_cross_attention(
    ...
    attention_maps = aggregate_attention(
        attention_store, res, from_where, True, select, batch_size
    )
    images = []
